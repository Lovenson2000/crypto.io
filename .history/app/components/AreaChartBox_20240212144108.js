        ...
        <AreaChart width={300} height={200} data={data}
            ...
            <defs>
                ...
                <linearGradient id="colorPv" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="5%" stopColor="#3f24ef" stopOpacity={0.8} />
                    <stop offset="95%" stopColor="#3f24ef" stopOpacity={0} />
                </linearGradient>
            </defs>
            {/* <XAxis />
            <YAxis /> */}
            ...
            <Area type="monotone" dataKey="pv" stroke="##3f24ef" fillOpacity={1} fill="url(#colorPv)" />
        </AreaChart>
