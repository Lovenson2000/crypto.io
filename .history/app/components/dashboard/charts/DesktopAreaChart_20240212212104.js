...
import { average, pickAndroundPrices, roundToDecimals } from '@/lib/utils';
...
export default function DesktopAreaChart({ coin }) {
    ...
    return (
        ...
        <AreaChart width={500} height={380} data={forma}
            ...
            />
            <Area type="monotone" dataKey="price" stroke="#924CF5" fillOpacity={1} fill="url(#colorPv)" />
        </AreaChart>
