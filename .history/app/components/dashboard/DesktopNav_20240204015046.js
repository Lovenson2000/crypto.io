...
export default function DesktopNav() {
    return (
        <div className=" flex justify-center w-full rounded-md flex-col gap-4">
            ...
            <div className="flex h-[48px] items-center justify-start gap-2 rounded-md bg-slate-100 p-3 text-sm font-medium hover:bg-sky-100 hover:text-blue-600 md:flex-none shadow-sm">
