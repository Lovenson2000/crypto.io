            ...
            <table className='w-full dark:bg-slate-900'>
                ...
                <tbody className='bg-white dark:bg-slate-800'>
                    {filteredCoins?.map((coin) => (
                        <tr
                            key={coin.id}
                            className="w-full grid grid-cols-3 grid-rows-2 border-b dark:border-slate-900 py-3 text-sm last-of-type:border-none [&:first-child>td:first-child]:rounded-tl-lg [&:first-child>td:last-child]:rounded-tr-lg [&:last-child>td:first-child]:rounded-bl-lg [&:last-child>td:last-child]:rounded-br-lg"
                        >
