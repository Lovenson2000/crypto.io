...
export default async function ChartWrapper() {
    ...
    return (
        <div>
            <h1 className='text-xl font-semibold mt-4 text-slate-600'>Most Popular</h1>
...
function BoxChart({ coin }) {
    return (
        <div className="dark:bg-slate-700 dark:text-slate-100 bg-white w-64 p-3 text-slate-700 relative border-b-2 border-main m-4 shadow-md rounded-sm">
            <Image
                width={30}
                height={30}
                src={coin.image}
