    ...
    <div className='h-full shadow-md flex flex-col px-3 py-4 md:px-2'>
      <div className='flex flex-col'>
        ...
        >
          ...
          <Sheet>
            <SheetTrigger className="w-12 flex items-end bg-blue-600">
              <TbMenuDeep className="font-semibold text-2xl" />
            </SheetTrigger>
            <SheetContent className='h-screen w-5/6 bg-red-500 flex flex-col justify-between'>
              <NavLinks />
              <div className="h-72 w-full rounded-md bg-gray-500 md:block"></div>
