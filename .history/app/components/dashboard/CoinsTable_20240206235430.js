                ...
                {coins?.map((coin) => (
                    ...
                    >
                        ...
                        <td className="whitespace-nowrap flex items-center px-3 py-3">
                            <span className='text-2xl'>{coin.market_cap_change_percentage_24h > 0 ? <IoMdArrowDropup className='text-green-500' /> : <IoMdArrowDropup className="text-red-600 rotate-180" />}</span>{coin.market_cap_change_percentage_24h}
                        </td>
                        <td className="whitespace-nowrap px-3 py-3">
                            {coin.market_cap}
                        </td>
