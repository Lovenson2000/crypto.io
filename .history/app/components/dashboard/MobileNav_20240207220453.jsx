...
export default function MobileNav() {
    return (
        <div
            className="dark:bg-slate-800 flex h-16 items-center justify-between rounded-md px-2"
        >
            ...
            <div>
                <Sheet>
                    ...
                    <SheetContent className='h-screen w-5/6 flex flex-col justify-between'>
                        ...
                        <div className="flex h-[48px] items-center justify-start gap-2 rounded-md bg-gray-50 p-3 text-sm font-medium hover:bg-indigo-100 hover:text-main md:flex-none">
