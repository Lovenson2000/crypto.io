            ...
            <div>
                <Sheet>
                    ...
                    <SheetContent className='h-screen w-5/6 flex flex-col justify-between'>
                        ...
                        <div className="flex h-[48px] items-center justify-start gap-2 rounded-md bg-gray-50 p-3 text-sm font-medium hover:bg-indigo-100 hover:text-indigo-700 md:flex-none">
