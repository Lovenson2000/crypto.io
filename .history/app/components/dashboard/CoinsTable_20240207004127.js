...
export default async function CoinsTable() {
    ...
    return (
        <table className='w-full'>
            <thead className="rounded-lg bg-red-500 text-left text-sm font-normal">
                <tr>
            ...
            <tbody className='bg-white'>
                {coins?.map((coin) => (
                    ...
                    >
                        ...
                        <Link
                            href=""
                            className="px-12 py-2 text-center bg-main text-white w-full rounded-full border-none outline-none"
                        >
                            See More
                        </Link>
