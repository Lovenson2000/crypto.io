...
export default function CoinConversionForm ({ coins }) {
    ...
    return (
        <form className="bg-white dark:bg-slate-800 p-4 rounded shadow-md">
            <h2 className="text-2xl text-slate-800 font-bold mb-4">Coin to Coin Conversion</h2>
            
            {/* The Coin To Convert From */}
            <div className="mb-4">
                <label htmlFor="baseCoin" className="block text-sm text-slate-800 font-medium">
                    From
                </label>
                <select
                    id="baseCoin"
            ...
            <div className="mb-4">
                <label htmlFor="amount" className="block text-sm text-slate-800 font-medium">
                    Amount to Convert
                </label>
                <input
                    type="number"
