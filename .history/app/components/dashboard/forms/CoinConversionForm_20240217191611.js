    ...
    return (
        <>
            <form className="bg-white dark:bg-slate-800 p-4 my-4 rounded shadow-md">
                ...
                <div className="mb-4">
                    ...
                    <select
                        ...
                        className="dark:bg-slate-900 bg-slate-100 mt-1 p-2 text-sm rounded-md w-full border-none outline-none"
                    >
                        {coins.map((coin) => (
                            <option
                                value={coin.name}
            ...
            {showConversionResult &&
                <div className="p-4 rounded-sm flex gap-2 bg-white dark:bg-slate-800">
