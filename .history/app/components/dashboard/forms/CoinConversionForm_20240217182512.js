        ...
        <form className="bg-white dark:bg-slate-800 p-4 my-4 rounded shadow-md">
            ...
            <div className="mb-4">
                ...
                <select
                    ...
                    className="dark:bg-slate-900 bg-slate-200 mt-1 p-2 rounded-md w-full border-none outline-none"
                >
                    {coins.map((coin) => (
                        <option
                            value={coin.name}
            ...
            <div className="mb-4">
                ...
                <select
                    ...
                    className="mt-1 p-2 rounded-md w-full active:border-2 border-indigo-600"
                >
                    {coins.map((coin) => (
                        <option
                            value={coin.name}
            ...
            <div className="mb-4">
                ...
                <input
                    ...
                    className="mt-1 p-2 rounded-md w-full outline-none active:border-2 border-indigo-600"
                />
            </div>
            <button
                type="submit"
