...
export default function CoinConversionForm({ coins }) {
    ...
    return (
        <div className="flex flex-col md:items-center md:justify-center">
            <form className="bg-white dark:bg-slate-800 md:w-1/2 p-4 my-4 rounded shadow-md">
            ...
            {showConversionResult &&
                <div className="p-4 md:w-1/2rounded-sm flex gap-2 bg-white dark:bg-slate-800">
