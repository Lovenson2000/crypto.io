        ...
        <AreaChart width={300} height={200} data={data}
            ...
            <defs>
                <linearGradient id="colorUv" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="5%" stopColor="#824CF5" stopOpacity={0.8} />
                    <stop offset="95%" stopColor="#824CF5" stopOpacity={0} />
                </linearGradient>
            ...
            <YAxis /> */}
            <Tooltip />
            <Area type="monotone" dataKey="uv" stroke="#824CF5" fillOpacity={1} fill="url(#colorUv)" />
