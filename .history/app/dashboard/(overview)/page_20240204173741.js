...
export default function Page() {
  ...
  return (
    <div className='flex items-center justify-center'>
      <div className="bg-white w-80 p-2 h-28 text-slate-700 relative border-b-2 border-main m-4 shadow-md rounded-sm">
        ...
        />
        <div className="flex w-full items-center mt-4 gap-2 justify-between">
          <div>
