    ...
    <main className="grid grid-cols-1 md:grid-cols-3">
      <div className="border grid grid-cols-1 md:col-span-2 w-full border-blue-500 items-center justify-center">
        ...
        <div className="border border-indigo-500 w-full">
          <div>
            <div className="dark:bg-slate-800 dark:text-slate-100 bg-white w-44 md:w-48 p-3 text-slate-700 relative border-b-2 border-main my-4 shadow-lg rounded-sm">
