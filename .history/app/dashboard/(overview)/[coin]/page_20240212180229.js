...
export default async function Page({ params }) {
  ...
  return (
    <main className="grid grid-cols-1 md:grid-cols-3 my-6 gap-6">
      ...
      <div className="border w-full border-red-500 p-4">
        <div className="flex flex-col gap-4">
          <button className="p-3 font-medium bg-slate-50 rounded-md text-slate-900 outline-none border-none"> Add to favorites</button>
        </div>
      </div>
