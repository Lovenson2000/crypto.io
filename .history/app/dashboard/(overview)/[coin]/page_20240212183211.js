...
export default async function Page({ params }) {
  ...
  return (
    <main className="w-full grid grid-cols-1 md:grid-cols-3 my-6 gap-6">
      <div className="grid grid-cols-1 col-span-2 w-full items-center justify-center gap-8">

        <CoinBoxWrapper coinData={coinData} />

        <div className="flex flex-col gap-4">
          <button className="p-2 font-normal text-lg bg-main rounded-md text-white outline-none border-none"> Add to favorites</button>
        </div>
