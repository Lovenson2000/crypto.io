  ...
  return (
    <main className="grid grid-cols-1 md:grid-cols-3 my-6 gap-6">
      ...
      <div className="flex items-center justify-center w-full">
        <button className="p-3 w-full font-medium shadow-2xl rounded-md bg-slate-800 hover:bg-slate-700 dark:bg-slate-700 dark:hover:bg-slate-800 text-slate-100 outline-none border-none"> Stimulate Trade</button>
      </div>
