...
export default async function Page({ params }) {
  ...
  return (
    <main className="grid grid-cols-1 md:grid-cols-3 my-6 gap-6">
      ...
      <div className="flex flex-col gap-4">
        <button className="p-3 font-medium shadow-2xl rounded-md bg-slate-800 hover:bg-slate-700 dark:bg-slate-700 dark:hover:bg-slate-800 text-slate-100 outline-none border-none"> Stimulate Trade</button>
      </div>
