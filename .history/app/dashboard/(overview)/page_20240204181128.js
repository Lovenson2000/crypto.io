...
export default async function Page() {
  ...
  return (
    <div className='flex items-center justify-center'>
      <div className="bg-white w-60 p-4 h-28 text-slate-700 relative border-b-2 border-main m-4 shadow-md rounded-sm">
        ...
        <div className="flex items-center mt-4 gap-2 h-full w-full justify-between">
          <div className="w-1/2">
            ...
            <p className="text-[.8rem]">${bitcoinaData.current_price}
              <span>{bitcoinaData.market_cap_change_percentage_24h > 0 ? <FaArrowTrendUp className="text-green-teal-500" /> : <FaArrowTrendDown />}
              </span>
            </p>
          </div>
          <div className="w-1/2">
