...
export default function Page() {
  ...
  return (
    <div className='flex items-center justify-center'>
      <div className="bg-white w-40 px-2 h-28 text-slate-700 relative border-b-2 border-main m-4 shadow-md rounded-sm">
        ...
        />
        <div className="flex items-center gap-2 mt-4 gap-2 h-full w-full justify-between">
