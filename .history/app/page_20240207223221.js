    ...
    <section className="dark:bg-slate-900 h-screen flex flex-col">
      ...
      <main className='flex flex-col md:flex-row items-center justify-center gap-8 pt-8 h-full pb-4 px-3 md:px-8 md:py-10'>
        ...
        <div className='flex flex-col justify-center gap-6'>
          ...
          <Link
            href="/dashboard"
            className="w-40 bg-main text-center text-white px-8 py-2 rounded-full hover:bg-third inline-block focus:outline-none">
            Get Started
          </Link>
        </div>
        ...
        <div>
          <Image
            ...
            height={500}
            alt='hero-image'
            className="object-contain w-min-80 object-center dark:mix-blend-lighten mix-blend-darken"
          />
        </div>
      </main>
