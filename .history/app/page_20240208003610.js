...
export default function Home() {
  ...
  return (
    <section className="dark:bg-slate-900 z-0 h-screen flex flex-col">
      <Header />
      <main className='flex flex-col md:flex-row items-center justify-center gap-8 pt-8 h-full pb-4 px-3 md:px-8 md:py-10'>
        ...
        <div>
          <Image
            ...
            height={500}
            alt='hero-image'
            className="object-contain w-min-80 object-center dark:mix-blend-multiply z-10 mix-blend-darken"
          />
        </div>
      </main>
