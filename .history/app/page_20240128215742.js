...
export default function Home() {
  ...
  return (
    <>
      <section className='py-8 px-3 md:px-8 md:py-10'>
        <div className='flex flex-col md:flex-row items-center justify-center gap-8'>
          ...
          <Image
            ...
            height={500}
            alt='hero-image'
            className="object-contain w-80 object-center"
          />
        </div>
      </section>

      <footer className="flex items-center justify-between md:px-8 px-3 w-full">
        <Link href="/" className="flex items-center gap-2">
          <Image
            ...
            className='rotate-90'
          />
          <h1 className="text-xl text-slate-800 font-bold">Crypto.<span className="text-xl font-bold">io</span></h1>
        </Link>
